...
export default async function FindPage({
  ...
  return (
    <div className="page">
      ...
      <section id="create" className="section" style={{ marginTop: 16 }}>
        <h2 className="section-title">Create a meetup</h2>
        <CreateMeetupForm defaultUniversity={me.university} />
      </section>

      <section className="section">
        <h2 className="section-title">Browse meetups</h2>
        {myClasses.length ? (
        ...
        <form method="get" style={{ display: "flex", gap: 8, flexWrap: "wrap", margin: "16px 0", alignItems: "center" }}>
          <input
            className="field"
            name="uni"
            list="uni-list"
        ...
        <div style={{ display: "grid", gap: 12 }}>
          {pageRows.length === 0 ? (
            <div className="card">No groups match these filters yet. Create one above.</div>
          ) : (
